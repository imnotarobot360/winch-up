...
--
-- Do not edit these rows in place once anyone has accepted them. Insert a new version instead:
-- `requests.waiver_id` points at the exact text a person agreed to, and that has to stay true.
-- ===========================================================================

insert into waivers (slug, version, is_current, body_en, body_es) values
(
